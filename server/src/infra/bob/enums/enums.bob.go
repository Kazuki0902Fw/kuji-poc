...
const (
	PurchaseTransactionsStatusPending   PurchaseTransactionsStatus = "pending"
	PurchaseTransactionsStatusPaid      PurchaseTransactionsStatus = "paid"
	PurchaseTransactionsStatusFailed    PurchaseTransactionsStatus = "failed"
	PurchaseTransactionsStatusCancelled PurchaseTransactionsStatus = "cancelled"
)

func AllPurchaseTransactionsStatus() []PurchaseTransactionsStatus {
	return []PurchaseTransactionsStatus{
		PurchaseTransactionsStatusPending,
		PurchaseTransactionsStatusPaid,
		PurchaseTransactionsStatusFailed,
		PurchaseTransactionsStatusCancelled,
	}
}
...
func (e PurchaseTransactionsStatus) Valid() bool {
	switch e {
	case PurchaseTransactionsStatusPending,
		PurchaseTransactionsStatusPaid,
		PurchaseTransactionsStatusFailed,
		PurchaseTransactionsStatusCancelled:
		return true
